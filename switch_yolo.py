...
# --- Configuration ---
OLD_DIR = Path("/cluster/scratch/nbaruffol/Anti-UAV-YOLO") # The folder where your files currently are
NEW_DIR = Path("/cluster/scratch/nbaruffol/dataset")       # The new root folder you want
